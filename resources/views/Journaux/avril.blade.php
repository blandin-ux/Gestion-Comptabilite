...
@else
<div class="container">
<h2 class="text-center mb-3 mt-3">Journal des Opérations du mois d'Avril</h2>
...
<a href="/suivis/create" class="btn btn-primary btn- float-left">Nouveau</a>
</div>
{{$suivis->links()}}
@endif
@endsection